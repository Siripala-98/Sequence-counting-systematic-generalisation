...
This repository contains the code and experiments from my MSc dissertation (City, University of London, 2024), which builds on [El-Naggar (2023)](https://openaccess.city.ac.uk/id/eprint/32428/) to investigate two approaches for inducing exact counting behaviour in RNNs.
